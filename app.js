...
const currentLeague = 'Harbinger';
const chaosCutOffPoint = 20;
let exaltToChaos;
let pricedUniques;
// let latestID = '107295783-112515506-105611526-121592033-113798215';
const getLatestID = () => __awaiter(this, void 0, void 0, function* () {
    try {
        let response = yield axios_1.default.get(`http://api.poe.ninja/api/Data/GetStats`);
        // console.log(response.data.next_change_id);
        return yield response.data.next_change_id;
    }
    catch (e) {
        console.log(e);
    }
});
const getCurrencyToChaosRatio = (name) => __awaiter(this, void 0, void 0, function* () {
    try {
        let response = yield axios_1.default.get(`http://poe.ninja/api/Data/GetCurrencyOverview?league=${currentLeague}`);
        let res = 0;
...
let filterLoop = () => {
    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let response = yield axios_1.default.get(`http://api.pathofexile.com/public-stash-tabs/?id=${latestID}`);
            ...
            let publicStashes = yield _.filter(response.data.stashes, (stash) => stash.public);
            ...
            let leagueStashes = yield _.filter(publicStashes, (stash) => {
